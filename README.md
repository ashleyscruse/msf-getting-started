...
| File | Description |
|------|-------------|
| [index.md](index.md) | Getting Started guide (hosted as GitHub Pages site) |
| [troubleshooting.md](troubleshooting.md) | Common issues and fixes |
| [examples/](examples/) | Sample Slurm job scripts |
| [admin/](admin/) | Admin tools (email templates, form automation) |

## For Administrators

The [admin/](admin/) folder contains:
- **Onboarding email template** — copy/paste email for welcoming new users
- **Google Apps Script** — auto-notification when someone submits the access request form
...
Ashley Scruse — Allocation Manager, Morehouse Supercomputing Facility
